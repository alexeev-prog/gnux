...
class SlugGenerator:
	...
	def generate_slug(self, phrase: str, symbol: str = "_") -> str:
		"""
		Generate slug
		...
		:rtype:		str
		"""
		slug = self._convert_to_slug(phrase, symbol)
		return slug

	def _convert_to_slug(self, phrase: str, symbol: str = "_") -> str:
		"""
		...
		"""
		slug = phrase.lower()
		slug = self._replace_spaces(slug, symbol)
	...
	def _replace_spaces(self, text: str, symbol: str = "_") -> str:
		"""
